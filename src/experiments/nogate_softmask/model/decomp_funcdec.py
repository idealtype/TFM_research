...
class FuncDecModel(nn.Module):
    """FuncDec model with physics-only seasonal basis and no learned gate.

    The seasonal decoder predicts Fourier coefficients directly. Coefficient
    sparsity is handled by the training loss.
    """
    ...
    def forward(self, emb, daily_basis, weekly_basis, monthly_basis, yearly_basis):
        ...
        seasonal_n, seasonal_coefficients = self.decoder_s(
            emb,
            daily_basis,
            weekly_basis,
            monthly_basis,
