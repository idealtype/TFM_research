#!/usr/bin/env python3
"""Fourier-warm + interleaved residual training for nogate_softmask.
...
DEFAULT_RESULTS_ROOT = Path(
    "/home/sia2/project/6.1nogate_softmask/results/"
    "interleaved_residual_mix_b1024_synth13_res13_coeffl1_no_final_resonly"
)
...
def main() -> None:
    ...
    print(
        ...
        f"coeff_l1_weight={args.coeff_l1_weight}",
        flush=True,
    )
