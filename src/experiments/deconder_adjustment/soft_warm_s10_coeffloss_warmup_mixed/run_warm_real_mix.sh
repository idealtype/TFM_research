#!/usr/bin/env bash
# Soft-mask Fourier coefficient-loss warm-start + real-dominant mixed training/evaluation.
set -euo pipefail

DEVICE=${DEVICE:-cuda:0}
PROJECT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
RESULTS=${RESULTS_ROOT:-$PROJECT/results/residual_head_tfm_style_warm_real_mix_synth13_b1024_parallel_coeff_effective_loss}
