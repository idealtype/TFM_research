...
RESULTS=${RESULTS_ROOT:-$PROJECT/results/residual_head_tfm_style_interleaved_residual_mix_synth13_res13_b1024_parallel_trend_seasonal_loss_no_final_resonly}
