...
echo "[projtarget-eval] checkpoint_run_dir=${CHECKPOINT_RUN_DIR}"
...
echo "[projtarget-eval] evaluate real LOTSA/ETTh1"
...
echo "[projtarget-eval] evaluate non-Fourier synthetic"
